...
describe UserStoriesController do
  ...
  let(:valid_attributes) { { "story" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_story as @user_story" do
        ...
        post :create, {:user_story => { "story" => "invalid value" }}, valid_session
        assigns(:user_story).should be_a_new(UserStory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_story" do
        ...
        UserStory.any_instance.should_receive(:update_attributes).with({ "story" => "MyText" })
        put :update, {:id => user_story.to_param, :user_story => { "story" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_story as @user_story" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserStory.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_story.to_param, :user_story => { "story" => "invalid value" }}, valid_session
        assigns(:user_story).should eq(user_story)
      end
